...
public class LIBRETTISTUDENTE {
    ...
    @XmlElementRef(name = "ID_ESSE3_AA_OFFERTA", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<Long> idesse3AAOFFERTA;
    @XmlElementRef(name = "ID_ESSE3_AA_ORD_AD", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ID_ESSE3_CDS_AD", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<Long> idesse3CDSAD;
    @XmlElementRef(name = "ID_ESSE3_PDS_AD", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
