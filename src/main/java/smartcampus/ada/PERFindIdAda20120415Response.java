...
public class PERFindIdAda20120415Response {
    ...
    @XmlElementRef(name = "PER_find_id_ada_20120415Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfPERPersona> perFindIdAda20120415Result;

    /**
     * Recupera il valore della proprietà perFindIdAda20120415Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà perFindIdAda20120415Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPersona }{@code >}
