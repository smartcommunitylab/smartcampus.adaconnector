...
public class PERFindCognomeNome20091229Response {
    ...
    @XmlElementRef(name = "PER_find_cognome_nome_20091229Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfPERPersona> perFindCognomeNome20091229Result;

    /**
     * Recupera il valore della proprietà perFindCognomeNome20091229Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà perFindCognomeNome20091229Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPersona }{@code >}
