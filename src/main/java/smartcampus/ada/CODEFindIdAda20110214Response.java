...
public class CODEFindIdAda20110214Response {
    ...
    @XmlElementRef(name = "CODE_find_id_ada_20110214Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfCODERelation> codeFindIdAda20110214Result;

    /**
     * Recupera il valore della proprietà codeFindIdAda20110214Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà codeFindIdAda20110214Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfCODERelation }{@code >}
