...
public class PERFindIdAdaResponse {
    ...
    @XmlElementRef(name = "PER_find_id_adaResult", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfPERPersona> perFindIdAdaResult;

    /**
     * Recupera il valore della proprietà perFindIdAdaResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà perFindIdAdaResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPersona }{@code >}
