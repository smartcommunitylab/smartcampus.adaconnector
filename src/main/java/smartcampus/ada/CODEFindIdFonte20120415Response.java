...
public class CODEFindIdFonte20120415Response {
    ...
    @XmlElementRef(name = "CODE_find_id_fonte_20120415Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfCODERelation> codeFindIdFonte20120415Result;

    /**
     * Recupera il valore della proprietà codeFindIdFonte20120415Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà codeFindIdFonte20120415Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfCODERelation }{@code >}
