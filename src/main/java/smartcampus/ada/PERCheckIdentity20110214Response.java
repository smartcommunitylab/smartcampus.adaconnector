...
public class PERCheckIdentity20110214Response {
    ...
    @XmlElementRef(name = "PER_check_identity_20110214Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfPERPersona> perCheckIdentity20110214Result;

    /**
     * Recupera il valore della proprietà perCheckIdentity20110214Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà perCheckIdentity20110214Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPersona }{@code >}
