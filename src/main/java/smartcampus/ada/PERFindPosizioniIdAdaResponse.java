...
public class PERFindPosizioniIdAdaResponse {
    ...
    @XmlElementRef(name = "PER_find_posizioni_id_adaResult", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfPERPosizioni> perFindPosizioniIdAdaResult;

    /**
     * Recupera il valore della proprietà perFindPosizioniIdAdaResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà perFindPosizioniIdAdaResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPosizioni }{@code >}
