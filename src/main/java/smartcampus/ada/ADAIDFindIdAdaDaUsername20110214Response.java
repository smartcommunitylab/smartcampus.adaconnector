...
public class ADAIDFindIdAdaDaUsername20110214Response {
    ...
    @XmlElementRef(name = "ADA_ID_find_id_ada_da_username_20110214Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfADAObjectID> adaidFindIdAdaDaUsername20110214Result;

    /**
     * Recupera il valore della proprietà adaidFindIdAdaDaUsername20110214Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà adaidFindIdAdaDaUsername20110214Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfADAObjectID }{@code >}
