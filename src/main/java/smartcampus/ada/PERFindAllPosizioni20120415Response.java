...
public class PERFindAllPosizioni20120415Response {
    ...
    @XmlElementRef(name = "PER_find_all_posizioni_20120415Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfPERPosizioni20091229> perFindAllPosizioni20120415Result;

    /**
     * Gets the value of the perFindAllPosizioni20120415Result property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the perFindAllPosizioni20120415Result property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPosizioni20091229 }{@code >}
