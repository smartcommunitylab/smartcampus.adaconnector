...
public class PERFindIdAda20091229Response {
    ...
    @XmlElementRef(name = "PER_find_id_ada_20091229Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfPERPersona> perFindIdAda20091229Result;

    /**
     * Gets the value of the perFindIdAda20091229Result property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the perFindIdAda20091229Result property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPERPersona }{@code >}
