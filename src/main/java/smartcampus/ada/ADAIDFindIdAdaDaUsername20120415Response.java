...
public class ADAIDFindIdAdaDaUsername20120415Response {
    ...
    @XmlElementRef(name = "ADA_ID_find_id_ada_da_username_20120415Result", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
    protected JAXBElement<ArrayOfADAObjectID> adaidFindIdAdaDaUsername20120415Result;

    /**
     * Recupera il valore della proprietà adaidFindIdAdaDaUsername20120415Result.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà adaidFindIdAdaDaUsername20120415Result.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfADAObjectID }{@code >}
