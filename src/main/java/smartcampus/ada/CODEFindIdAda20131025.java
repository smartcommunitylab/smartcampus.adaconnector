...
@XmlRootElement(name = "CODE_find_id_ada_20131025")
public class CODEFindIdAda20131025 {
    ...
    @XmlElementRef(name = "id_local", namespace = "http://Data.ADAWs.unitn.it", type = JAXBElement.class)
